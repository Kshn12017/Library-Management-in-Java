...
@WebServlet(urlPatterns = {"/issueserve"})
public class issueserve extends HttpServlet {
                ...
                if(request.getParameter("b1")!=null)
                {
                    try
                    {
                        Class.forName("org.apache.derby.jdbc.ClientDriver");
                         ...
                         stat.executeUpdate("insert into IssueBook values("+bid+",'"+name+"', "+roll+",'"+clas+"')");
