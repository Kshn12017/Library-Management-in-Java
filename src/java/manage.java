...
"    </table>"
                ...
                {
                    stat.executeUpdate("insert into BookList values("+bid+", '"+name+"', '"+genre+"', '"+author+"', "+quantity+")");
                ...
                {
                    stat.executeUpdate("update BookList set Book_Name='"+name+"', Genre='"+genre+"', Author='"+author+"', Quantity="+quantity+" where Book_ID="+bid+"");
                ...
                {
                    stat.executeUpdate("delete from BookList where Book_ID="+bid+"");
