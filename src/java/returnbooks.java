 ...
 * @author kshit
 */
@WebServlet(urlPatterns = {"/returnbooks"})
            ...
            if(ses.getAttribute("name")!=null)
            {
                ...
                try{
                    ...
                    Class.forName("org.apache.derby.jdbc.ClientDriver");
                        ...
                        ResultSet rs = stat.executeQuery("select * from ReturnBook");
                        out.println("<table  style=\"text-align:center\" border=1>");
                        out.println("<tr><th>Book ID</th><th>Student Name</th><th>Roll No.</th><th>Class</th><th>Returned By</th></tr>");
                        while(rs.next())
                        {
                            ...
                            String quantity = rs.getString("Returner");
                            out.println("<tr><td>"+bid+"</td><td>"+name+"</td><td>"+genre+"</td><td>"+author+"</td><td>"+quantity+"</td></tr>");
                        }
                        out.println("</table>");
                }
                catch(Exception e)
